...
export default function AddEmployeePage() {
  ...
  const employeeId = generateEmployeeId(nextIdNum - 1);
  ...
  const onSubmit = (data: FormData) => {
    addEmployee({
      ...data,
      photo: `https://ui-avatars.com/api/?name=${encodeURIComponent(data.fullName)}&background=random`
    });
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input value={employeeId} disabled className="bg-slate-50 font-mono" />
            </div>
            <div className="space-y-2">
        ...
        <div className="flex justify-end gap-2 pt-4">
          ...
          <Button type="submit" className="bg-indigo-600 hover:bg-indigo-700">Add Employee</Button>
        </div>
      </form>
    </div>
  );
